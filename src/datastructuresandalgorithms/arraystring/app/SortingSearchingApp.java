...
import datastructuresandalgorithms.arraystring.fun.SortingSearching;
...
public class SortingSearchingApp {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
        /*	System.out.println("default sorted datastructures.array");
			sortingSearching.traverseArray(sortedArray);
			System.out.println("default unsorted datastructures.array");
			sortingSearching.traverseArray(datastructures.array);*/
