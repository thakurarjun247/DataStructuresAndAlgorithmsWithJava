...
public class PrimsAlgo {
    ...
    {
		/* Let us create the following datastructures.graph
		2 3
		(0)--(1)--(2)
		| / \ |
		6| 8/ \5 |7
    ...
    // Function to construct and print MST for a datastructures.graph represented
    ...
    void primMST(int graph[][])
    {
        ...
        for (int count = 0; count < V - 1; count++) {
            ...
            for (int v = 0; v < V; v++)
                ...
                // datastructures.graph[u][v] is non zero only for adjacent vertices of m
                // verticesAlreadyIncludedInMST[v] is false for vertices not yet included in MST
                // Update the candidateKeysForNextEdge only if datastructures.graph[u][v] is smaller than candidateKeysForNextEdge[v]
