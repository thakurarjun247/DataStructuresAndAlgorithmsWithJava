package problemsfrombooks.epi.ch12searching;
...
public class SearchSorted2DMatrix {
    ...
    //see explanation in problemsfrombooks.epi, we can also use a[rowHigh][colLow] instead of a[rowLow][colHigh] for comparison
