...
public class SortingSearching {
    ...
    public void displayChoice() {
        ...
        System.out.println(" 0: modify the default unsorted array ");
    ...
    public void modifyArray(int[] array) {
        ...
        System.out.println("array modified, here it is...");
        traverseArray(array);
    }
    ...
    public int binarySearchIterative(int[] sortedAscendingArray, int key) {
        ...
        System.out.println(key + " not found in following array");
        traverseArray(sortedAscendingArray);
        return -1;
    }
    ...
    public int[] selectionSort(int[] a) {
        // scan the array and find the smallest element
...
/*		for (int i = low; i <=high; i++) {
		 ...
		 * the smaller element from the two halves 28 * into the original array.
		 */
		 ...
		 * helper array are copied into the target array. Why not the right half? The
