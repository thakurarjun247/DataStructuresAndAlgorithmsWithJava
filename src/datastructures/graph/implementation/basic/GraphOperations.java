...
public class GraphOperations {
    ...
    public void displayChoice() {
        ...
        System.out.println(" 3: dfs with datastructures.stack ");
        System.out.println(" 7: dfsNew with datastructures.stack ");
    ...
    public void dfs(Vertex start, Graph graph) {
        ...
        //datastructures.stack.push(start);
        ...
        if (start.getAdjacencyList().size() != 0) {
            for (int i = 0; i < start.getAdjacencyList().size(); i++) {
                ...
                while (!stack.empty()) {
                    dfs(stack.pop(), graph);
                    //although pop throws exception if datastructures.stack is empty but
